...
<!-- 		<view class="header">
		...
		<view class="cartList">
			<view class="cartItem" v-for="(shopItem,index) in cartList" :key="shopItem.id">
				...
				@click="changeShopItemSelected(!shopItem.selected,index)"
				 :class="shopItem.selected?'selected':''"></text>
				<view class="shopItem">
				...
				<view class="countCtrl">
					<text class="add" @click="changeShopItemCount(1,index)"> + </text>
					<text class="count"> {{shopItem.count}} </text>
					<text class="del" @click="changeShopItemCount(-1,index)"> - </text>
				</view>
			</view>
		...
		<view class="cartFooter">
			...
			@click="changeSelectedAll(!isSelectedAll)"
			 :class="isSelectedAll?'selected':''"></text>
...
<script>
	...
	export default {
		...
		methods:{
			changeShopItemCount(num,index){
				this.changeShopItemCountMutation({num,index});
				// console.log(num)
			},
